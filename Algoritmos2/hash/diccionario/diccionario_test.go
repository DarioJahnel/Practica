...
func hashingKR(clave string) int {
	seed := uint32(131)
	hash := uint32(0)
...
func TestDiccionarioVacio(t *testing.T) {
	...
	dic := TDADiccionario.CrearHash[string, string](hashing)
...
func TestUnElement(t *testing.T) {
	...
	dic := TDADiccionario.CrearHash[string, int](hashing)
	dic.Guardar("A", 10)
...
func pruebasTresElementos(t *testing.T, h func(string) int) {
	clave1 := "Gato"
	clave2 := "Perro"
	clave3 := "Vaca"
	valor1 := "miau"
	...
	dic := TDADiccionario.CrearHash[string, string](h)
...
func TestDiccionarioGuardar(t *testing.T) {
	...
	pruebasTresElementos(t, hashing)
}

func TestGuardarConColisiones(t *testing.T) {
	t.Log("Guarda algunos pocos elementos en el diccionario, asegurandose de generar una colsion, y se comprueba " +
		"que en todo momento funciona acorde")
	pruebasTresElementos(t, func(string) int {
		return 0
	})
}

func TestGuardarConClaveDeHashEnorme(t *testing.T) {
	t.Log("Prueba guardar una clave que tenga un valor de hash enorme")
	clave := FUERA_DE_RANGO
	dic := TDADiccionario.CrearHash[string, int](func(string) int {
		return 10000000
	})
	dic.Guardar(clave, 1)
...
func pruebasTresElementosBorrar(t *testing.T, h func(string) int) {
	clave1 := "Gato"
	clave2 := "Perro"
	clave3 := "Vaca"
	valor1 := "miau"
...
func TestDiccionarioBorrar(t *testing.T) {
	...
	pruebasTresElementosBorrar(t, hashing)
}

func TestBorrarConColisiones(t *testing.T) {
	t.Log("Guarda algunos pocos elementos en el diccionario, asegurandose de generar una colsion,y se los borra, " +
		"revisando que en todo momento el diccionario se comporte de manera adecuada")
	pruebasTresElementosBorrar(t, func(a string) int {
		return 0
	})
}
...
func TestConClavesNumericas(t *testing.T) {
	...
	dic := TDADiccionario.CrearHash[int, string](func(num int) int {
		return num
	})
	clave := 10
	valor := "Gatito"
...
func TestConClavesStructs(t *testing.T) {
	...
	dic := TDADiccionario.CrearHash[avanzado, int](func(a avanzado) int {
		return a.x.b
	})
...
func TestCadenaLargaParticular(t *testing.T) {
	...
	cadena := "%d~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~" +
		"~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~"
	dic := TDADiccionario.CrearHash[string, string](hashingKR)
...
func pruebaIterInternoCon3(t *testing.T, h func(string) int) {
	clave1 := "Gato"
	clave2 := "Perro"
	clave3 := "Vaca"
	claves := []string{clave1, clave2, clave3}
	dic := TDADiccionario.CrearHash[string, *int](h)
...
func TestIteradorInternoClaves(t *testing.T) {
	...
	pruebaIterInternoCon3(t, hashing)
}

func TestIteradorInternoClavesConColisiones(t *testing.T) {
	t.Log("Valida que todas las claves sean recorridas (y una única vez) con el iterador interno")
	pruebaIterInternoCon3(t, func(a string) int {
		return 0
	})
}
...
func probarIterarCon3(t *testing.T, h func(string) int) {
	clave1 := "Gato"
	clave2 := "Perro"
	clave3 := "Vaca"
	valor1 := "miau"
...
func TestDiccionarioIterar(t *testing.T) {
	...
	probarIterarCon3(t, hashing)
}

func TestDiccionarioIterarConColisiones(t *testing.T) {
	t.Log("Guardamos 3 valores en un Diccionario, asegurándonos que hayan colisiones, e iteramos validando que " +
		"las claves sean todas diferentes pero pertenecientes al diccionario. Además los valores de VerActual y " +
		"Siguiente van siendo correctos entre sí")
	probarIterarCon3(t, func(a string) int {
		return 0
	})
}
